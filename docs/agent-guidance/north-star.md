...
3. **Stalwart Docker harness.** Seed deterministic accounts, messages, calendars, contacts, and protocol endpoints for local/CI tests.
...
- Stalwart Docker protocol suite in local and CI.
