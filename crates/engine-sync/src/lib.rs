...
pub use outbox::{
    CalendarWriteOutcome, ContactWriteOutcome, DrainOutcome, DrainReport, DrainedOp,
    MailEditOutcome, ReportOutcome, SubmitOutcome, create_calendar_event, create_contact,
    delete_calendar_event, delete_contact, drain_outbox, edit_mail, patch_calendar_event,
