//! Host-facing people, recipient, contact-write, and photo APIs.

use std::collections::{BTreeMap, BTreeSet};

use engine_core::{
    contact::{
        ContactCard, ContactDraft, ContactKind, ContactPatch, ContactResource, ContactSourceClass,
    },
...
use engine_provider::{ContactDestination, ContactPhoto, ContactsProvider};
