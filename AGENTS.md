...
- `docs/agent-guidance/e2e.md` before touching end-to-end protection (`engine_core::e2e`, `engine-e2e`, or anything that signs, encrypts, verifies or decrypts mail).
- `docs/agent-guidance/openpgp.md` and `openpgp-conformance.md` before touching `engine-openpgp` or its conformance tables.
